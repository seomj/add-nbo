...
# Project:  add-nbo.pro
# Template: app
# Command: /opt/Qt/6.1.2/gcc_64/bin/qmake -o Makefile add-nbo.pro
#############################################################################
...
DISTDIR = /root/gilgil/homework/add-nbo/add-nbo/.tmp/add-nbo1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)    
AR            = ar cqs
...
Makefile: add-nbo.pro /opt/Qt/6.1.2/gcc_64/mkspecs/linux-g++/qmake.conf /opt/Qt/6.1.2/gcc_64/mkspecs/features/spec_pre.prf \
		/opt/Qt/6.1.2/gcc_64/mkspecs/common/unix.conf \
		/opt/Qt/6.1.2/gcc_64/mkspecs/common/linux.conf \
		/opt/Qt/6.1.2/gcc_64/mkspecs/common/sanitize.conf \
		/opt/Qt/6.1.2/gcc_64/mkspecs/common/gcc-base.conf \
